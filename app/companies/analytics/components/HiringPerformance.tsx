  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 mb-1">Hiring Performance</h2>
          <p className="text-gray-600">Recruitment funnel and success metrics</p>
        </div>
      </div>

      {/* Key Metrics */}
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="border border-emerald-200 rounded-lg p-4 flex flex-col">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-lg md:text-xl font-medium text-emerald-800">Hiring Rate</span>
          </div>
          <div className="text-2xl md:text-4xl dm-serif text-emerald-900 self-end ">{performance.hiring_rate}%</div>
        </div>

        <div className="border border-brand3 rounded-lg p-4 flex flex-col">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-lg md:text-xl font-medium text-brand">Interview Success</span>
          </div>
          <div className="text-2xl md:text-4xl dm-serif text-brand3 self-end">{performance.interview_to_hire_ratio}%</div>
        </div>
      </div>
