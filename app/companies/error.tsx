...
interface CompaniesErrorPageProps {
  error: Error & { digest?: string }
  reset: () => void
}

export default function CompaniesErrorPage({ error, reset }: CompaniesErrorPageProps) {
  return (
      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-6">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto">
            We&apos;re experiencing technical difficulties with your company dashboard. 
        ...
        <div className="space-y-4 mb-8">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="/companies/dashboard" className="flex items-center justify-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="/companies/jobs" className="flex items-center justify-center gap-2">
            ...
            <Button
              ...
              className="text-gray-600 hover:text-gray-900"
            >
              <Link href="/companies/applications" className="flex items-center justify-center gap-2">
